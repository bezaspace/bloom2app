...
import type { ConnectionStatus } from "../useVoiceAssistant";
...
import type { OnboardingStatus, WellnessPlan } from "../onboarding";
...
export function VoiceAssistantScreen({ onLogout }: VoiceAssistantScreenProps) {
  const {
    status,
    isSpeaking,
    isListening,
  ...
  const handleUploadDoc = useCallback(async () => {
    ...
    try {
      ...
      if (response.status === "success") {
        const bioCount = response.biomarkers_extracted ?? 0;
        setUploadMsg(
          `Uploaded "${response.filename}" — processed successfully.` +
            (bioCount > 0 ? ` ${bioCount} biomarkers extracted.` : ""),
        );
        void refreshOnboarding();
      } else {
...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 12, color: "#cbd5e1", fontWeight: "500" },
  transcript: { flex: 1, paddingHorizontal: 16 },
  transcriptContent: { paddingVertical: 16 },
  emptyHint: {
    color: "#64748b",
    textAlign: "center",
    marginTop: 60,
  ...
  cursor: { color: "#94a3b8", fontSize: 15 },
  errorBar: {
  ...
  controls: { paddingHorizontal: 20, paddingVertical: 16, paddingBottom: 28 },
  connectButton: {
  ...
  disconnectButtonText: { color: "#94a3b8", fontWeight: "600" },
  micButton: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  logoutButtonText: { color: "#94a3b8", fontSize: 12, fontWeight: "600" },
  onboardingBanner: {
    backgroundColor: "#1e293b",
    marginHorizontal: 16,
    marginTop: 12,
  ...
  uploadButtonDisabled: { backgroundColor: "#475569" },
  uploadButtonText: { color: "#fff", fontSize: 14, fontWeight: "600" },
  uploadMsg: { color: "#a5b4fc", fontSize: 12, marginTop: 8 },
  planButton: {
    backgroundColor: "#6366f1",
    marginHorizontal: 16,
    marginTop: 12,
  ...
  planButtonText: { color: "#fff", fontSize: 14, fontWeight: "600" },
  planModalHeader: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  planModalTitle: { fontSize: 20, fontWeight: "700", color: "#f8fafc" },
  planModalClose: {
    backgroundColor: "#1e293b",
    paddingHorizontal: 14,
    paddingVertical: 8,
  ...
  planModalCloseText: { color: "#94a3b8", fontWeight: "600" },
  planModalBody: { flex: 1, paddingHorizontal: 20 },
  planModalBodyContent: { paddingVertical: 20 },
  planSummary: {
    color: "#e2e8f0",
    fontSize: 15,
    lineHeight: 22,
  ...
  docSummaryText: { color: "#cbd5e1", fontSize: 13, lineHeight: 19 },
});
